...
function ProjectAdd(ProjectName,ProjectDes,ProjectLink,ProjectImg) {
    ...
    if(ProjectName.length==0){
     $('#toastrFa').removeClass('d-none').toast('show').html("Project Name is Empty !");
    }
    else if(ProjectDes.length==0){
     $('#toastrFa').removeClass('d-none').toast('show').html("Project Description is Empty !");
    }
    else if(ProjectLink.length==0){
      $('#toastrFa').removeClass('d-none').toast('show').html("Project Link is Empty !");
    }
    else if(ProjectImg.length==0){
      $('#toastrFa').removeClass('d-none').toast('show').html("Project Image is Empty !");
    }
  ...
  $('#ProjectDeleteConfirmBtn').html("<div class='spinner-border spinner-border-sm' role='status'></div>") //Animation....
    axios.post('/ProjectDelete', {
        ...
        getProjectData();
              ...
              $('#ProjectDeleteConfirmBtn').html("Yes");
             $('#deleteProjectModal').modal('hide');
             t$('#toastrFa').removeClass('d-none').toast('show').html("Something Went Wrong !");
            }
