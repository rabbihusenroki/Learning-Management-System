...
function ReviewAdd(ReviewName,ReviewDes,ReviewImg) {
    ...
    if(ReviewName.length==0){
     $('#toastrFa').removeClass('d-none').toast('show').html("Review Name is Empty !");
    }
    else if(ReviewDes.length==0){
     $('#toastrFa').removeClass('d-none').toast('show').html("Review Description is Empty !");
    }
    else if(ReviewImg.length==0){
      $('#toastrFa').removeClass('d-none').toast('show').html("Review Image is Empty !");
    }
